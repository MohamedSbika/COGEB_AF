...
<div className="w-full h-32 bg-gray-500/50 rounded-lg"></div>
                    ...
                    :
                    <section id='admin'>
                              <div className="w-full h-32 bg-gray-400"></div>

                        <div className="container py-7 md:py-16 max-w-5xl">
                            <h1 className='text-center text-2xl font-heading font-bold text-black'>Mise à jour  Poste</h1>
                            <div className="mt-8 form_container">
                                        ...
                                        <div className="info_container">
                                            ...
                                            <div className="additional_info mt-6 max-w-xs">
                                                ...
                                                <div className="property_type">
                                                    <p className='font-heading text-black'>type</p>
                                ...
                                ">
                                                ...
                                                <div className="property_info mt-3">
                                                    <p className='font-heading text-black'>Informations Génerale</p>
                                                    ...
                                                    <div className="max-w-[200px] flex items-center justify-between gap-2 mt-2">
                                                        <span className='label-text font-medium'>chambre</span>
                                                        <div>
                                                            <input
                                                                className='border-2 focus:border-[#3A5A40] rounded-md max-w-[84px] min-w-[84px] py-1 px-2 bg-transparent'
                                                                min={1} max={10}
                                                ...
                                                <div className="additional_feature mt-3">
                                                    <p className='font-heading text-black'>Informations additionnel</p>
                                                    <div className="form-control">
                                                        <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                            <input
                                                                id='parking'
                                                        ...
                                                        <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                            <input
                                                                ...
                                                                {...register('furnished')}
                                                            />
                                                            <span className="label-text font-medium" >Meublées</span>
                                                        </label>
                                                ...
                                                <div className=" mt-1">
                                                    ...
                                                    </div>
                                                    {
                                                        isOffer &&
                                                        <div className="pricing_info flex flex-col">
                                                            <p className="mt-3  font-heading text-black"> Prix d'offre </p>
                                                            <span className='text-sm font-content font-bold text-red-900'>($ /month)</span>
                                                            <div className="flex flex-row mt-2 ">
                                                                <span className="flex items-center bg-grey-lighter rounded rounded-r-none px-2 font-bold text-grey-darker text-xl">$</span>
                                                                <input
