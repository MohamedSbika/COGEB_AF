    ...
    return (
        <main >
            ...
            <div className="w-full h-32 bg-gray-500/50 rounded-lg"></div>
                    ...
                    <h1 className='text-center text-2xl font-heading font-bold text-black'>Ajouter Une Post</h1>
                                ...
                                <div className="info_container">
                                    ...
                                    <div className="additional_info mt-6 max-w-xs">
                                        ...
                                        <div className="property_type">
                                            <p className='font-heading text-black'>Selectionnez le type de poste</p>
                                            ...
                                            ">
                                                    ...
                                                    <span className="label-text font-medium">à Vendre</span>
                                                </label>
                                            </div>
                                            ...
                                            ">
                                                    <input
                                                        ...
                                                        {...register('type')}
                                                    />
                                                    <span className="label-text font-medium">à Louer</span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div className="cd_info mt-3">
                                            ...
                                            <div className="max-w-[200px]  flex items-center justify-between gap-2 mt-2">
                                                <span className='label-text font-medium'>Chambres</span>
                                                <div>
                                                    <input
                                                        defaultValue={1}
                                            ...
                                            <div className="max-w-[200px] flex items-center justify-between gap-2 mt-1">
                                                <span className='label-text font-medium'>Salle de bain</span>
                                                <div>
                                                    <input
                                                        defaultValue={1}
                                                        className='border-2 focus:border-[#3A5A40] rounded-md max-w-[84px] min-w-[84px] py-1 px-2 bg-transparent'
                                        ...
                                        <div className="additional_feature mt-3">
                                            <p className='font-heading text-black'>Information Additionel </p>
                                            <div className="form-control">
                                                <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                    <input
                                                        id='parking'
                                                ...
                                                <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                    ...
                                                    />
                                                    <span className="label-text font-medium" >Avez-vous un discount?</span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div className=" mt-1">
                                            <div className="pricing_info flex flex-col">
                                                <p className="mt-3  font-heading text-black">Prix </p>
                                                <div className="flex flex-row mt-2 ">
                                                    <span className="flex items-center bg-grey-lighter rounded rounded-r-none px-2 font-bold text-grey-darker text-xl text-red-900">DT</span>
                                                    <input
                                                        id='price'
                                                        type="number"
                                                        name="price"
                                            ...
                                            </div>
                                            {
                                                isOffer &&
                                                <div className="pricing_info flex flex-col">
                                                    <p className="mt-3  font-heading text-black">Prix aprés discount </p>
                                                    <div className="flex flex-row mt-2 ">
                                                        <span className="flex items-center bg-grey-lighter rounded rounded-r-none px-2 font-bold text-grey-darker text-xl  text-red-900">DT</span>
                                                        <input
                                                            id='discountPrice'
