        ...
        <>
            <section>
                ...
                <div className="w-full h-32 bg-gray-500/50 rounded-lg"></div>
                    <div className="heading_cotainer  border-b-2 pt-2 pb-5 border-[#3A5A40]e flex items-center justify-center sm:justify-between flex-col sm:flex-row gap-3">
                        <h1 className='font-heading text-2xl text-left '>Vos postes enregistrés</h1>
                        <button
                            ...
                            saveListings.length === 0 ?
                                <div className='py-20'>
                                    ...
                                    <p className='bg-white text-center text-sm sm:text-2xl font-heading font-bold flex flex-col items-center justify-center max-w-3xl mx-auto py-10 text-black px-5 rounded shadow-md'>
                                        <span>Votre liste d'enregistrement des posts est vide .</span>
                                    </p>
