...
const CreateProject = () => {
    ...
    return (
        <main >
            <section id='admin'>
            <div className="w-full h-32 bg-gray-500/50 rounded-lg"></div>                <div className="container py-7 md:py-16 max-w-5xl">
                                    ...
                                    <div className="additional_info mt-6 max-w-xs">
                                        ...
                                        <div className="property_type">
                                            ...
                                            ">
                                                    ...
                                                    <span className="label-text font-medium">non commencée</span>
                                                </label>
                                            </div>
