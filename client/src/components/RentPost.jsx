    ...
    function SampleNextArrow(props) {
       ...
       useEffect(() => {
        (async () => {
            try {
                setLoading(true)
                const res = await fetch(`/api/posts/search?type=rent`)
        ...
        < section >
            ...
            >
                <div className="content">
                    ...
                    Découvrez nos postes à louer et trouvez votre espace idéal parmi notre sélection diversifiée. Que vous recherchiez un appartement moderne en ville ou une maison spacieuse en banlieue, nous avons ce qu'il vous faut. Explorez nos propriétés disponibles et commencez à envisager votre prochain chez-vous avec nous.                    </p>
                </div>
                ...
                <div className="btn_container flex items-center justify-center">
                    <button
                        ...
                        onClick={() => navigate('/search?filter=rent')}
                        >
