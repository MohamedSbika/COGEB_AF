            ...
            <div className="card-container">
                ...
                >
                    ...
                    <div className="absolute bottom-2 left-2 bg-[#3A5A40] py-1 px-2 ">
                        <p className='text-xs text-white  font-heading uppercase rounded-sm shadow-sm'>{type === 'rent' ? 'louer' : type === 'sale' ? 'vendre' : ''}
                        </p>
                    </div>
                    {
                        offer && <div className="absolute top-2 right-0 bg-amber-400 py-1 px-2 ">
                            <p className='text-xs capitalize text-black font-heading'>Offer!</p>
                        </div>
                    }
                </div>
