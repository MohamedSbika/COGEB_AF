...
export default function Card1() {
  return (
    <div>
      <div className="bg-[#E8F7FF] shadow-lg shadow-gray-500/40 sm:mt-10 mt-2 h-auto grid place-items-center max-h-full max-w-[100vw]  sm:pt-40 mx-auto sm:p-32 p-6 font-[sans-serif]">
        <div className="grid md:grid-cols-2 items-center gap-4 ">
          <div>
            <img
              src={cov}
              className="grid place-items-center sm:ml-8 rounded-lg shadow-[-25px_-25px_0px_rgba(11,79,72,1)]"
              alt="Profile"
            />
          </div>
          <div className="md:col-span-1">
            <div className="mb-12 sm:max-w-[50vw]">
              <h2 className="text-[#0B4F48] text-3xl font-extrabold">
              A PROPOS DE NOUS
              </h2>
