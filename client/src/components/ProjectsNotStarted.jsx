            ...
            >
                <div className="content">
                    <h2 className='text-3xl font-bold sm:text-5xl font-heading  text-[#3A5A40] sm:text-left '>
                        Nos Projects non commencés
                    </h2>
                    <p className='font-content  font-medium text-sm sm:text-lg mt-3 max-w-3xl'>
                    Découvrez nos projets immobiliers non commencés, où chaque plan est une vision de l'avenir résidentiel. Plongez dans notre vision avant-gardiste de l'habitat, où l'innovation et la créativité façonnent chaque espace. Explorez nos concepts prometteurs et préparez-vous à vivre une nouvelle ère de confort et de style.                    </p>
                </div>
