    ...
    function SampleNextArrow(props) {
       ...
       useEffect(() => {
        (async () => {
            try {
                setLoading(true)
                const res = await fetch(`/api/projects/search?etat=en cours`)
        ...
        < section >
            ...
            >
                <div className="content">
                    ...
                    Découvrez nos projets immobiliers en cours et plongez dans l'avenir de l'habitat moderne. Explorez notre portfolio dynamique où chaque projet est une promesse d'innovation et de qualité. Joignez-vous à nous dans la création d'espaces de vie exceptionnels qui redéfinissent la standard en matière d'immobilier.                    </p>
                </div>
                ...
                <div className="btn_container flex items-center justify-center " >
                    <button
                        ...
                        onClick={() => navigate('/searchProject?filter=en cours')}
                        >
