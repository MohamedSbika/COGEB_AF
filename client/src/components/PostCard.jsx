            ...
            >
                ...
                >
                    ...
                    <span className="text-xs text-white uppercase font-heading">
                        Pour {type === 'rent' ? 'louer' : type === 'sale' ? 'vendre' : ''}
                    </span>
                    </div>
                ...
                <div className="p-4">
                    ...
                    >
                        ...
                        <div className='mt-3 flex items-end justify-start'>
                            ...
                            <p className='text-[#3A5A40] w-1/2 font-content font-semibold text-sm flex items-center '><FaBed className='mr-1' /><span className='font-heading font-bold mr-1'>{bed}</span> Chambres</p>



                            <p className='text-[#3A5A40] w-1/2 font-content font-semibold text-sm flex items-center '><FaBath className='mr-1' /><span className='font-heading font-bold mr-1'>{bath}</span> S.de bain</p>
                        </div>
                        ...
                        <div className="mt-3 flex items-end justify-between">
                            {offer ?
                                <p className='font-content truncate'>
                                    <span className="text-2xl font-bold font-content text-[#3A5A40] ">{discountPrice} DT</span>
                                    {
                                        type === 'rent' && <span className="text-sm text-[#3A5A40]">/m</span>
                                    }
                                    <s className='font-bold text-sm text-gray-500 ml-2 truncate'>${price} DT</s>
                                </p>

                                : <p className='font-content truncate'>
                                    <span className="text-2xl font-bold font-content text-[#3A5A40] ">{price} DT</span>
                                    {
                                        type === 'rent' && <span className="text-sm text-[#3A5A40]">/mois</span>
                                    }
                                </p>}

                            <div className="inline-flex rounded-xl max-w-[150px]  duration-500">
                                <p className='font-heading text-lg truncate'>{postInfo.post.area ? postInfo.post.area : 0} <span className='font-content'> m²</span> </p>
                            </div>
                        </div>
                    </div>
